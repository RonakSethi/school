                    ...
                    <div class="card-box">
                        <div style="width: 23%" class="search_div-table pull-right">
                            <div class="form-group ">
                                <?php echo $this->Form->create("User", array("action" => "admin_schools", "type" => "POST", "class" => "validateForm cmxform form-horizontal ", "id" => "searchUsers", 'enctype' => 'multipart/form-data')); ?>                      
                                <div class="form-group ">
