                    ...
                    <div class="card-box">
                        <div style="width: 23%" class="search_div-table pull-right">
                            <div class="form-group ">
                                     <?php 
                                      $parentId = $this->params['pass'][0];
                                     echo $this->html->link('<i class="fa fa-plus"></i>', array('admin' => true, 'controller' => 'users', 'action' => 'add_students',$parentId), array('class' => 'on-default edit-row', 'escape' => false)); ?>
                                                    ...
                                                    foreach ($users as $u) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
                                                                ...
                                                                <?php echo $this->html->link('<i class="fa fa-pencil"></i>', array('admin' => true, 'controller' => 'users', 'action' => 'edit', $u['User']['id']), array('class' => 'on-default edit-row', 'escape' => false)); ?>

                                                                <?php echo $this->html->link('<i class="fa fa-trash-o"></i>', array('admin' => true, 'controller' => 'users', 'action' => 'delete', $u['User']['id']), array('class' => 'on-default remove-row', 'escape' => false, 'confirm' => 'Are you sure? you want to delete this record!!')); ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
