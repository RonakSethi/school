<section id="main-content">
    <section class="wrapper">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <div class="form">
                            <?php echo $this->Form->create("Bus", array("action" => "edit", "method" => "Post", "class" => "cmxform form-horizontal ", "id" => "addBus", 'enctype' => 'multipart/form-data')); ?>
	 ...
	 echo $this->Form->hidden('Bus.id', array('label' => '', 'div' => false));
							echo $this->Form->end(); ?>
                        </div>
                    </div>
                </section>
