            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <div class="form">
                            <?php echo $this->Form->create("Trip", array("action" => "edit", "method" => "Post", "class" => "cmxform form-horizontal ", "id" => "addTrip", 'enctype' => 'multipart/form-data')); 
							 echo $this->Form->hidden('Trip.id', array('label' => '', 'div' => false));
							?>
