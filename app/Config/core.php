...
// Configure::write('Twilio.AccountSid','ACd0ceda37b11b49b98fbc6f4c628bfbdd');
// Configure::write('Twilio.AuthToken', 'b0dc6dd02c9a151700ea697772c335f1');
// Configure::write('Twilio.from','test');
 ...
 */
Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi12');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '7685930965745354249674968364512');
...
/* Few variables to be used globally in this application */
if (!defined('INACTIVE')) {
    define('INACTIVE', '0');
}
if (!defined('ACTIVE')) {
...
if (!defined('PriceFormatSymbol')) {
    define('PriceFormatSymbol', '$');
}
if (!defined('DEFAULT_DEMO_TIME')) {
    define('DEFAULT_DEMO_TIME', '180');
}
if (!defined('USER_IMAGE_PATH')) {
...
if (!defined('PRODUCT_IMAGE_PATH')) {
    ...
    if (!defined('FACEBOOK_APP_ID')) {
       // define('FACEBOOK_APP_ID', '1625379841084193');
        define('FACEBOOK_APP_ID', '1625378494417661');
    }
    if (!defined('GOOGLE_API')) {
        define('GOOGLE_API', 'AIzaSyA0DykFh-fiJdRw9rGx8DjDptvMHxCNfNo');
    }
    if (!defined('GOOGLE_CLIENT_ID')) {
        define('GOOGLE_CLIENT_ID', '182252999964-aqfj4dpss4tahf3682akbrsh65r1jg33.apps.googleusercontent.com');
    }
    if (!defined('GOOGLE_CLIENT_SECRATE')) {
...
//Added By Rahul 
define('WEBSITE_URL', Configure::read('Site.url'));
//Added By Ronak 

define('IMAGE_URL', Configure::read('Site.url') . 'images/');
//Social Links
Configure::write('Site.facebook', 'https://www.facebook.com');
Configure::write('Site.twitter', 'https://www.twitter.com');
Configure::write('Site.google+', 'https://plus.google.com');
